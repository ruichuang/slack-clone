// way not pure function because will do state & keep tracking it.
...
class Register extends React.Component {
  ...
  onChange = (e) => {
    ...
    // [name] = "email";
    // use [] around name because we want to use prop name "email" but not name.
...
// inject mutation to component by using higher order component

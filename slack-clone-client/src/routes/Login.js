...
class Login extends React.Component {
  ...
  /**
   * instand of using onChange(e) {}, which have to pass this object to the function by using
   * this.onChange = this.onChange.bind(this), so use => arrow functtion, auto pass this object
   * to the function
   */
  ...
  onSubmit = async () => {
    ...
    // this mutate function injected form apollo
